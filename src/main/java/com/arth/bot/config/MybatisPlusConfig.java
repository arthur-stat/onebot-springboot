...
public class MybatisPlusConfig {
    ...
    public void checkSqlConnectionAndTables() {
        try (Connection conn = dataSource.getConnection()) {
            ...
            log.info("[sql] table check results - t_user: {}, t_group: {}, t_membership: {}, t_subscription: {}",
                    userTableExists, groupTableExists, membershipTableExists, subscriptionTableExists);
